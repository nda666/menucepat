<form id="attendanceSearchForm">
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <x-select-horizontal label="Tipe" id="filterAttendanceType" name="filterAttendanceType" autocomplete="off"
        placeholder="Cari dari nama pegawai atau NIK">
        <option value="">Semua</option>
        @php
          $attendanceType = \App\Enums\AttendanceType::toSelectArray();
        @endphp
        @foreach ($attendanceType as $k => $v)
