                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <x-adminlte-input name="nama" type="text" label="Nama" required autocomplete="off"
                            placeholder="Nama" fgroup-class="col-md-6" />
                        <x-adminlte-input name="email" type="email" label="Email" required autocomplete="off"
                            placeholder="mail@example.com" fgroup-class="col-md-6" />
                    </div>
                    <div class="row">
                        <x-adminlte-input label="Whatsapp" required autocomplete="off" name="whatsapp"
                            class="form-control" id="whatsapp" placeholder="Whatsapp" fgroup-class="col-md-4" />
                        ...
                        <x-adminlte-input label="NIK" required autocomplete="off" name="nik" class="form-control"
                            id="nik" placeholder="NIK" fgroup-class="col-md-4" />
                    </div>
                    <div class="row">
                        <x-adminlte-input type="password" label="Password" name="password" class="form-control"
                    ...
                    <div class="row">
                        ...
                        <x-date-picker :id="'tglLahir'" name="tgl_lahir" required autocomplete="off"
                            placeholder="Tanggal lahir" label="Tanggal Lahir" fgroup-class="col-md-4" />
                        <x-adminlte-input label="Kota Kelahiran" name="kota_lahir" required autocomplete="off"
                            class="form-control" id="kota_lahir" placeholder="Kota Kelahiran"
                    ...
                    <div class="row">
                        <x-adminlte-input label="Divisi" required autocomplete="off" name="divisi"
                            class="form-control" id="divisi" placeholder="Divisi" fgroup-class="col-md-6" />
                        <x-adminlte-input label="Sub Divisi" required autocomplete="off" name="subdivisi"
                            class="form-control" id="subdivisi" placeholder="Sub Divisi" required autocomplete="off"
                            fgroup-class="col-md-6" />
                    ...
                    <div class="row">
                        <x-adminlte-input label="Company" name="company" class="form-control" id="company"
                            placeholder="Company" fgroup-class="col-md-6" />
                    ...
                    <div class="row">
                        <x-adminlte-input label="Jabatan" name="jabatan" class="form-control" id="jabatan"
                            placeholder="Jabatan" fgroup-class="col-md-4" />
                        <x-adminlte-input label="Lokasi" name="lokasi" class="form-control" id="lokasi"
                            placeholder="Lokasi" fgroup-class="col-md-4" />
                        <x-adminlte-input label="Bagian" name="bagian" class="form-control" id="bagian"
                            placeholder="Bagian" fgroup-class="col-md-4" />
                    </div>
    ...
    <script>
        (function() {
            ...
            $('#modalCreateUser').on('submit', 'form', function(e) {
                ...
                $.ajax({
                    url: id ? "{{ url('user/') }}/" + id :
                    "{{ route('user.store') }}", // if id exist use update URL
